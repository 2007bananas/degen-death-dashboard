...
st.set_page_config(page_title="🩸 LIFE OR DEATH DEGEN DASHBOARD", layout="wide", initial_sidebar_state="collapsed")

st.markdown("""
<style>
    .stApp { background: #0a0a0a; color: #ff0044; font-family: 'Courier New'; }
    .big-number { font-size: 4rem; font-weight: bold; color: #00ff88; text-shadow: 0 0 20px #00ff88; }
...
st.title("🩸 LIFE OR DEATH DEGEN DASHBOARD")
